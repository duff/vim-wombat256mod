...
" General colors
hi Normal		ctermfg=252		ctermbg=234		cterm=none		guifg=#e3e0d7	guibg=Black		gui=none
...
hi LineNr		ctermfg=241		ctermbg=232		cterm=none		guifg=#857b6f	guibg=#1c1c1c	gui=none
